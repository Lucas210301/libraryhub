...
Sistema de gestão de empréstimos de biblioteca, desenvolvido para o projeto da segunda VA da
disciplina Programação Orientada a Objetos (Ciência da Computação — UFAPE).
...
`IItemService`, `ILoanService`, `IMemberRepository`, `IItemRepository` e `ILoanRepository`.
...
O back end sobe em `http://localhost:8080` e o front end em `http://localhost:3000`.
...
- `GUIA_PASSO_A_PASSO.md` — roteiro de montagem, execução, testes e entrega.
- `GUIA_3VA.md` — roteiro da terceira VA: branch, testes e commits.
- `RELATORIO_3VA.md` — relatório de desenvolvimento da terceira VA.
